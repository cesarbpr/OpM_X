...
class Graficar:
    ...
    def __init__(self):
        ...
        self.ax1.set_ylabel('q1 [deg]')
        # self.ax1.set_title('Respuesta temporal')
        self.ax2.set_ylabel('i1 [A]')
        self.ax3.set_ylabel('q2 [deg]')
        self.ax4.set_ylabel('i2 [A]')
        self.ax5.set_ylabel('q3 [deg]')
        self.ax6.set_ylabel('i3 [A]')
        self.ax7.set_ylabel('q4 [deg]')
    ...
    def create_point(self):
        ...
        q_des1 = np.rad2deg(self.qdes_vec[0])
        q_des2 = np.rad2deg(self.qdes_vec[1])
        q_des3 = np.rad2deg(self.qdes_vec[2])
        q_des4 = np.rad2deg(self.qdes_vec[3])
        qreal1 = np.rad2deg(self.qreal_vec[0])
        qreal2 = np.rad2deg(self.qreal_vec[1])
        qreal3 = np.rad2deg(self.qreal_vec[2])
        qreal4 = np.rad2deg(self.qreal_vec[3])
        u1 = self.u_vec[0]
        u2 = self.u_vec[1]
        u3 = self.u_vec[2]
        u4 = self.u_vec[3]
